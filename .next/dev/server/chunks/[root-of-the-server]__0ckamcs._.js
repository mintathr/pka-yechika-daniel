...
async function GET() {
    ...
    return NextResponse.json(
      ...
      { status: 500 }
        ...
        const [rows] = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].query("SELECT * FROM budgets");
        return Response.json({
            total_data_di_array: rows.length,
            isi_array_ke_0: rows[0],
            semua_data: rows
        });
    } catch (error) {
        return Response.json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0ckamcs._.js.map